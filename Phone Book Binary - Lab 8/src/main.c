...
About: A simple phonebook where you can view, create, and delete contacts. This is a modified version of lab #7 to include the reading of and writing to a binary file
*/
...
void read_binary(char *binaryfile) {
    ...
    if (infp == NULL) {
        printf("Error opening binary file. Aborting save operation....\n");
        return;
    }
